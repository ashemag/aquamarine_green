...
const founder = {
    ...
    image: '/team/lily-schwabe-circle.png',
};
                ...
                <div className="w-full px-4 sm:px-8 lg:px-12 max-w-5xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-center">
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <span className="text-charcoal/30 font-body text-[10px] tracking-[0.2em] uppercase mb-2">Founded by</span>
                            <h3 className="font-display text-2xl md:text-3xl text-charcoal">
                                {founder.name}
                            </h3>
                            <p className="font-body text-charcoal/40 text-xs tracking-[0.15em] uppercase mt-2">
                                {founder.role}
                            </p>
                        ...
                        <div className="text-center lg:text-left">
                            <span className="text-charcoal/30 font-body text-xs tracking-[0.2em] uppercase">Our Approach</span>
                            <h2 className="font-display text-2xl sm:text-3xl md:text-4xl text-charcoal mt-3 mb-6">
                                Design, Build, Refine
                            </h2>
                            ...
                            <div className="mt-8 md:mt-12 grid grid-cols-3 gap-2 sm:gap-4">
                                {['Design', 'Build', 'Refine'].map((phase, index) => (
                                    <div key={phase} className="flex flex-col items-center lg:items-start">
                                        <span className="font-display text-2xl sm:text-3xl md:text-4xl text-charcoal/10">{index + 1}</span>
                                        <span className="font-display text-sm sm:text-base md:text-lg text-charcoal -mt-1 sm:-mt-2">{phase}</span>
                                    </div>
                                ))}
                            </div>
                        </div>
